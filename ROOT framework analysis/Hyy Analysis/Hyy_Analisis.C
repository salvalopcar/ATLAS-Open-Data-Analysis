 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // AJUSTE DEL BACKGROUND
    ...
    // CONVERTED Y UNCONVERTED PHOTONS
        ...
        std::cout << " " << std::endl;
        std::cout << "AJUSTE A UN POLINOMIO DE ORDEN 3 PARA myy1:" << std::endl;
    ...
    // UNCONVERTED PHOTONS
        ...
        std::cout << " " << std::endl;
        std::cout << "AJUSTE A UN POLINOMIO DE ORDEN 3 PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;
  ...
  // AJUSTE DEL SIGNAL + BACKGROUND
    ...
    // CONVERTED Y UNCONVERTED PHOTONS
        ...
        std::cout << " " << std::endl;
        std::cout << "AJUSTE A UNA GAUSSIANA + EXPONENCIAL PARA myy1:" << std::endl;
    ...
    // UNCONVERTED PHOTONS
        ...
        std::cout << " " << std::endl;
        std::cout << "AJUSTE A UNA GAUSSIANA + EXPONENCIAL PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;
    ...
    // CONVERTED Y UNCONVERTED PHOTONS
        ...
        hist_myy1_Data -> Add ( myy1_bkg1, -1 );
          ...
          // AJUSTE AL DATA - BACKGROUND
            ...
            std::cout << " " << std::endl;
            std::cout << "AJUSTE POLINOMIO DE ORDEN 3 DEL RATIO PLOT PARA myy1:" << std::endl;
            ...
            std::cout << " " << std::endl;
            std::cout << "AJUSTE A UNA GAUSSIANA DEL RATIO PLOT PARA myy1:" << std::endl;
    ...
    // UNCONVERTED PHOTONS
        ...
        hist_myy2_Data -> Add ( myy2_bkg1, -1 );
          ...
          // AJUSTE AL DATA - BACKGROUND
            ...
            std::cout << " " << std::endl;
            std::cout << "AJUSTE A UN POLINOMIO DE ORDEN 3 DEL RATIO PLOT PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;
            ...
            std::cout << " " << std::endl;
            std::cout << "AJUSTE A UNA GAUSSIANA DEL RATIO PLOT PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;
