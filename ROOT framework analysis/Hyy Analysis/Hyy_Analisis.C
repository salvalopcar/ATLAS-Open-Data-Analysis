...
void Hyy_Analisis () {
 ...
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // ABRIR DATOS
    ...
    // WH HIGGS
        ...
        if ( tipo == 3 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para HW Higgs:" << std::endl;
    ...
    // ZH HIGGS
        ...
        if ( tipo == 4 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para ZW Higgs:" << std::endl;
    ...
    // tt HIGGS
        ...
        if ( tipo == 5 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para tt Higgs:" << std::endl;
  ...
  // AJUSTE DEL BACKGROUND

    // CONVERTED Y UNCONVERTED PHOTONS

        std::cout << " " << std::endl;
        std::cout << "AJUSTE EXPONENCIAL PARA myy1:" << std::endl;
    ...
    // UNCONVERTED PHOTONS
        ...
        std::cout << " " << std::endl;
        std::cout << "AJUSTE EXPONENCIAL PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;
  ...
  // AJUSTE DEL SIGNAL + BACKGROUND

    // CONVERTED Y UNCONVERTED PHOTONS

        std::cout << " " << std::endl;
        std::cout << "AJUSTE GAUSSIANA PARA myy1:" << std::endl;
    ...
    // UNCONVERTED PHOTONS
        ...
        std::cout << " " << std::endl;
        std::cout << "AJUSTE GAUSSIANA PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;
  ...
  // TEXTO #sqrt{13} = TeV, 10 fb^{-1} Y H -> yy
  ...
  // DIBUJAR HISTOGRAMAS
    ...
    // CONVERTED Y UNCONVERTED PHOTONS
        ...
        hist_myy1_Data -> Add ( myy1_bkg1, -1 );
          ...
          // AJUSTE AL DATA - BACKGROUND

            std::cout << " " << std::endl;
            std::cout << "AJUSTE EXPONENCIAL DEL RATIO PLOT PARA myy1:" << std::endl;

            TF1 *myy1_bkg2 = new TF1 ("myy1_bkg2", "expo", 105, 160);
            myy1_bkg2 -> SetLineColor (kBlue);
            myy1_bkg2 -> SetLineStyle (kDashed);
            hist_myy1_Data -> Fit ("myy1_bkg2", "B");


            std::cout << " " << std::endl;
            std::cout << "AJUSTE GAUSSIANA DEL RATIO PLOT PARA myy1:" << std::endl;

            TF1 *myy1_sigbkg2 = new TF1 ("myy1_sigbkg2", "gausn", 105, 160);
            myy1_sigbkg2 -> SetParameters (150, 125, 2);
            myy1_sigbkg2 -> SetParLimits (0, 100, 200);
            myy1_sigbkg2 -> SetParLimits (1, 120, 130);
            myy1_sigbkg2 -> SetParLimits (2, 1, 4);
            myy1_sigbkg2 -> SetLineColor (kRed);
            hist_myy1_Data -> Fit ("myy1_sigbkg2", "B");
    ...
    // UNCONVERTED PHOTONS
        ...
        hist_myy2_Data -> Add ( myy2_bkg1, -1 );
          ...
          // AJUSTE AL DATA - BACKGROUND
            ...
            std::cout << " " << std::endl;
            std::cout << "AJUSTE EXPONENCIAL DEL RATIO PLOT PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;

            TF1 *myy2_bkg2 = new TF1 ("myy2_bkg2", "expo", 105, 160);
            myy2_bkg2 -> SetLineColor (kBlue);
            myy2_bkg2 -> SetLineStyle (kDashed);
            hist_myy2_Data -> Fit ("myy2_bkg2", "B");


            std::cout << " " << std::endl;
            std::cout << "AJUSTE GAUSSIANA DEL RATIO PLOT PARA myy2 (UNCONVERTED PHOTONS):" << std::endl;

            TF1 *myy2_sigbkg2 = new TF1 ("myy2_sigbkg2", "gausn", 105, 160);
            myy2_sigbkg2 -> SetParameters (150, 125, 2);
            myy2_sigbkg2 -> SetParLimits (0, 100, 200);
            myy2_sigbkg2 -> SetParLimits (1, 120, 130);
            myy2_sigbkg2 -> SetParLimits (2, 1, 4);
            myy2_sigbkg2 -> SetLineColor (kRed);
            hist_myy2_Data -> Fit ("myy2_sigbkg2", "B");
        ...
        hist_myy2_Data -> SetMaximum (150);
        hist_myy2_Data -> SetMinimum (-150);
