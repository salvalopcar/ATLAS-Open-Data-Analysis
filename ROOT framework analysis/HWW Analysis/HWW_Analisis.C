	...
	fChain -> SetBranchAddress ( "lep_n",                             &Lep_n,                                 &b_Lep_n );
      ...
      // SELECTION CRITERIA
        ...
        for ( i = 0; i < nentries; i++)
        {
            ...
            if ( tipo == 1 )        // Cross Section for ggF
            {
            ...
            if ( tipo == 2 )        // Cross Section for VBF
            {
            ...
            if ( tipo == 3 )        // Scale factor for WZ diboson
            {
            ...
            if ( tipo == 4 )        // Scale factor for WW diboson
            {
