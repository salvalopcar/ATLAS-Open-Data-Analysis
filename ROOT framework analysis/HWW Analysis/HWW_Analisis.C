...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // ABRIR DATOS
    ...
    // DIBOSON
      ...
      // WZ
        ...
        if ( tipo == 3 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para Diboson WZ:" << std::endl;
      ...
      // WW
        ...
        if ( tipo == 4 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para Diboson WW:" << std::endl;
      ...
      // ZZ
        ...
        if ( tipo == 5 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para Diboson ZZ:" << std::endl;
    ...
    // V JETS
        ...
        if ( tipo == 6 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para V + jets:" << std::endl;
    ...
    // TOP - ANTITOP
        ...
        if ( tipo == 7 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para top - antitop:" << std::endl;
    ...
    // SINGLE TOP
        ...
        if ( tipo == 8 )
        {
            ...
            std::cout << " " << std::endl;
            std::cout << "Análisis para single top:" << std::endl;
    ...
    // LEER LOS DATOS
      ...
      // CRITERIOS DE SELECCIÓN
        ...
        for ( i = 0; i < nentries; i++)
        {
            ...
            float norm = 1;         // Factor de normalización

            if ( tipo == 1 )        // Cambia la sección eficaz del ggF porque es distinta a la de los archivos
            {
            ...
            if ( tipo == 2 )        // Cambia la sección eficaz del ggF porque es distinta a la de los archivos
            {
            ...
            if ( tipo == 3 )        // Cambia la normalización para el diboson WZ
            {
            ...
            if ( tipo == 4 )        // Cambia la normalización para el diboson WW
            {
                    ...
                    if ( Lep_pt -> at(goodlep1_index) > 22000. )
                    {
                        ...
                        if ( Lep_charge -> at(goodlep1_index) * Lep_charge -> at(goodlep2_index) == -1 )
                        {
                            ...
                            if ( Lep_type -> at(goodlep1_index) != Lep_type -> at(goodlep2_index) )
                            {
                                ...
                                TLorentzVector Lepton_1 = TLorentzVector ();        // TLorentzVector del primer leptón
                                TLorentzVector Lepton_2 = TLorentzVector ();        // TLorentzVector del segundo leptón
                                TLorentzVector MeT = TLorentzVector ();             // TLorentzVector de Etmiss
                                ...
                                TLorentzVector Lepton_12 = TLorentzVector ();       // TLorentzVector de la suma de leptones
                                Lepton_12 = Lepton_1 + Lepton_2;

                                float mLL = Lepton_12.Mag() / 1000.;            // Masa del sistema leptónico en GeV
                                float ptLL = Lepton_12.Pt() / 1000.;            // Momento transverso del sistema leptónico en GeV
                    
                                float dPhiLL = TMath::Abs ( Lep_phi -> at(goodlep1_index) - Lep_phi -> at(goodlep2_index) );           // Ángulo entre los leptones
                                dPhiLL = dPhiLL < TMath::Pi() ? dPhiLL : 2*TMath::Pi() - dPhiLL;

                                float dPhiLLmet = TMath::Abs ( Lepton_12.Phi() - Met_phi );                            // Ángulo entre Etmiss y el sistema leptónico
                                dPhiLLmet = dPhiLLmet < TMath::Pi() ? dPhiLLmet : 2*TMath::Pi() - dPhiLLmet;

                                float mt = sqrt( 2 * Lepton_12.Pt() * MeT.Et() * ( 1 - cos( Lepton_12.DeltaPhi(MeT) ) ) )/1000.;    // Masa transversa del sistema dileptónico en GeV

                                Met_et = Met_et / 1000.;        // Pasar Etmiss de MeV a GeV


                                // RELLENAR HISTOGRAMAS ANTES DE LOS CORTES
  ...
  // CÁLCULO DE LA INTEGRAL DE LOS HISTOGRAMAS
    ...
    // DIBOSON
        ...
        std::cout << " " << std::endl;
        std::cout << "CÁLCULO DE LAS INTEGRALES PARA DIBOSON:" << std::endl;
    ...
    // V + JETS
        ...
        std::cout << " " << std::endl;
        std::cout << "CÁLCULO DE LAS INTEGRALES PARA V+JETS:" << std::endl;
    ...
    // TOP - ANTITOP
        ...
        std::cout << " " << std::endl;
        std::cout << "CÁLCULO DE LAS INTEGRALES PARA TOP - ANTITOP:" << std::endl;
    ...
    // SINGLE TOP
        ...
        std::cout << " " << std::endl;
        std::cout << "CÁLCULO DE LAS INTEGRALES PARA SINGLE TOP:" << std::endl;
  ...
  // MOSTRAR OVERFLOW EN LOS HISTOGRAMAS
  ...
  // TEXTO #sqrt{13} = TeV, 10 fb^{-1} Y H -> WW* -> e#mu + #mu e
